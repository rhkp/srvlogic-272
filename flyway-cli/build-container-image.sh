...
cleanup () {
    ...
    rm -rf tmp
    rm -f src/main/cekit/modules/kogito-postgres-db-migration-deps/flyway-cli-1.0-SNAPSHOT-runner.jar
}
...
cp target/flyway-cli-1.0-SNAPSHOT-runner.jar src/main/cekit/modules/kogito-postgres-db-migration-deps
